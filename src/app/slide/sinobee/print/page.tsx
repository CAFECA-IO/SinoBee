...
import SinoBeeSlide1 from '@/app/slide/sinobee/1/page';
import SinoBeeSlide2 from '@/app/slide/sinobee/2/page';
      ...
      <div className="fixed top-4 right-4 z-50 flex gap-2 print:hidden backdrop-blur-md bg-white/80 p-2 rounded-lg shadow-lg border border-gray-200 items-start">
        ...
        <div className="relative">
          <button
            ...
            className="px-4 py-2 bg-amber-600 text-white rounded-md text-sm font-bold shadow-md hover:bg-amber-700 transition-colors flex items-center gap-2 h-10"
            disabled={isExporting}
          >
            ...
            <div className="absolute top-12 right-0 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 p-4 transition-all animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all placeholder:text-gray-400"
                />
              ...
              <button
                ...
                className="w-full py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-sm font-bold shadow-md transition-all active:scale-[0.98] flex justify-center items-center gap-2"
              >
                <Download size={16} />
                Start Export
              </button>
